...
| [ADR-007](0007-dual-protocol-era-support.md) | Support both 2025-11-25 and 2026-07-28 in the 2.0 SDK | **Accepted** (2026-08-09) | ADR-002 items 1 and 5; ADR-003 item 5 | ADR-008 (protocol-version scope) |
| [ADR-008](0008-tri-version-secure-transports.md) | Tri-version protocol adapters and secure transport policies | **Accepted** (2026-08-10) | ADR-007 protocol-version scope | — |
